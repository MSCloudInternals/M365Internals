@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Expanded the Microsoft 365 admin authentication surface with credential, ESTS cookie, Temporary Access Pass, phone sign-in, browser, SSO, and software passkey connection flows, while keeping Connect-M365Portal as the central admin bootstrap path.'
