@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Expanded the Microsoft 365 admin authentication surface with credential, ESTS cookie, Temporary Access Pass, phone sign-in, browser, SSO, and software passkey connection flows, added read-only plus write-capable app-setting, company-setting, security-setting, people-setting, Microsoft 365 Groups-setting, and user-owned app cmdlets, introduced dedicated Agent Frontier access and Copilot pin policy cmdlets, and standardized Settings-family getter output with broad -Raw and -RawJson support.'
