@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Added grouped read-only Agents coverage for Overview, All agents, Tools, and Settings, alongside the existing Copilot and Settings cmdlets and improved portal REST request handling.'
