@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Added read-only Office Scripts, Project, Dynamics 365 Connection Graph, and Dynamics 365 Sales Insights app coverage, alongside grouped and write-capable user-owned apps and app-setting cmdlets.'
