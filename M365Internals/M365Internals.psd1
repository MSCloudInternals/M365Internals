@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Added grouped read-only Copilot coverage for Overview, Connectors, Billing & usage, and Settings, alongside the broader Settings menu cmdlets and improved portal REST request handling.'
